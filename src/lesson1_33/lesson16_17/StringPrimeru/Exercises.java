package lesson1_33.lesson16_17.StringPrimeru;
...
public class Exercises {
    public static void main(String[] args) {
        ...
        System.out.println(test.replace("e",""));


        System.out.println(Arrays.toString(countDuplicates(test, new String[]{"or", "some", "test"})));

        String str = "Today is good day... Helloy";

        System.out.println(replase(str, "is", "that"));
        System.out.println(replase(str, "o", " "));
        System.out.println(replase(str, "To", "PPP"));
        System.out.println(replase(str, "lo", "X"));
    ...
    public static String replase(String input, String target, String replacement) {
    ...
    private static boolean checkReplace(String input, String target, int index) {
        ...
        for (int i = 0; i < replaceChars.length && index < inputChar.length; i++, index++)
            if (inputChar[index] != replaceChars[i]) return false;
